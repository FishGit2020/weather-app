...
export default function DashboardSettings({ visibility, onChange }: Props) {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-20 py-2">
          ...
          {(Object.keys(WIDGET_LABELS) as Array<keyof WidgetVisibility>).map((key) => (
            ...
            >
              ...
              />
              <span className="text-gray-700 dark:text-gray-300">{WIDGET_LABELS[key]}</span>
            </label>
          ))}
        </div>
      )}

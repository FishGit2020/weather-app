...
const en = {
  ...
  'wear.waterBottle': 'Carry water bottle',
...
const es: Record<TranslationKey, string> = {
  ...
  'wear.openShoesSandals': 'Zapatos abiertos o sandalias',
  ...
  'wear.sunscreen': 'Protector solar',
  'wear.hatSunProtection': 'Sombrero para protección solar',
  'wear.moistureWicking': 'Telas que absorben la humedad',
